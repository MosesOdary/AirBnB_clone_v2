...
Routes:
    /: Displays 'Hello HBNB!'.
    /hbnb: Displays 'HBNB'.
    /c/<text>: Display'C' followed by val of <text>.
    /python/(<text>): Display'Python' followed by value of <text>.
    /number/<n>: Displays'n is a number' only if <n> is int.
...
def c(text):
    ...
    Replaces underscores in with slashes.
    """
    text = text.replace("_", " ")
...
def python(text="is cool"):
    """Displays 'Python' followed by val of <text>
